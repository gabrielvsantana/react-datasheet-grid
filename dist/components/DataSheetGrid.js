...
const useScrollbarSize_1 = require("../hooks/useScrollbarSize");
const DEFAULT_DATA = [];
...
exports.DataSheetGrid = react_1.default.memo(react_1.default.forwardRef(({ value: data = DEFAULT_DATA, className, style, height: maxHeight = 400, onChange = DEFAULT_EMPTY_CALLBACK, columns: rawColumns = DEFAULT_COLUMNS, rowHeight = 40, headerRowHeight = typeof rowHeight === 'number' ? rowHeight : 40, gutterColumn, stickyRightColumn, rowKey, addRowsComponent: AddRowsComponent = AddRows_1.AddRows, createRow = DEFAULT_CREATE_ROW, autoAddRow = false, lockRows = false, disableExpandSelection = false, duplicateRow = DEFAULT_DUPLICATE_ROW, contextMenuComponent: ContextMenuComponent = ContextMenu_1.ContextMenu, disableContextMenu: disableContextMenuRaw = false, onFocus = DEFAULT_EMPTY_CALLBACK, onBlur = DEFAULT_EMPTY_CALLBACK, onActiveCellChange = DEFAULT_EMPTY_CALLBACK, onSelectionChange = DEFAULT_EMPTY_CALLBACK, rowClassName, cellClassName, onScroll, initialColumnWidths, onColumnsResize, }, ref) => {
    ...
    const [heightDiff, setHeightDiff] = (0, useDebounceState_1.useDebounceState)(20, 100);
    const [resizedColumnWidths, setResizedColumnWidths] = (0, react_1.useState)(initialColumnWidths !== null && initialColumnWidths !== void 0 ? initialColumnWidths : {});
    const [resizing, setResizing] = (0, useDebounceState_1.useDebounceState)(false, 50);
    // FIXME: this needs to be calculated on the first render somehow
    const [horizontalScroll, setHorizontalScroll] = (0, react_1.useState)(false);
    const scrollbarSize = (0, useScrollbarSize_1.useScrollbarSize)();
    const resizeCallback = (val) => {
        setResizing(true);
        setResizedColumnWidths(val);
    };
    const resizeEndCallback = (val) => {
        setResizing(false);
        onColumnsResize === null || onColumnsResize === void 0 ? void 0 : onColumnsResize(val);
    };
    ...
    const { width: innerWidth } = (0, react_resize_detector_1.useResizeDetector)({
        skipOnMount: true,
        targetRef: innerRef,
        refreshMode: 'throttle',
        refreshRate: 100,
    ...
    const { fullWidth, totalWidth: contentWidth, columnsMap, columnWidths, columnRights, } = (0, useColumnWidths_1.useColumnWidths)(columns, width, resizedColumnWidths);
    ...
    return (react_1.default.createElement(useColumnsWidthContext_1.ColumnWidthsContext.Provider, { value: {
            columnWidths,
            initialColumnWidths,
            columnsMap,
